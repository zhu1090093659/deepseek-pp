...
| 2 | Critical Boundaries and Failure Safety | [#44](https://github.com/zhu1090093659/deepseek-pp/milestone/44) | 6 | Privileged message/tool paths reject invalid context; Android bridge is minimized; sync is atomic/recoverable; automation cancellation prevents late side effects. | annotate 2 / replan 3 / rescope 4 | Pending |

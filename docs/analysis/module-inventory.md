...
本清单基于 2026-07-13 Issue #345 工作树，排除 `node_modules/`、`dist/`、`docs/archives/` 和生成资产。`core/skill/*-official/` 中约 1.1 MB 的 bundled Skill 文档作为资源记录，不计入 TypeScript LOC。Android 支持面已删除。
...
| `tests/` | Vitest/jsdom 单元与契约测试 | 覆盖广但没有真实浏览器、完整 migration/fault injection 或 coverage gate | 97 / 16,487 | Medium | S🟢 U🟢 P🟡 E🟡 R🟡 |

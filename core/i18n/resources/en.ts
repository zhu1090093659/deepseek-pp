...
export const en = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      multimodalApiDescription: 'Configure OpenAI, Gemini, and SiliconFlow analysis with custom request URLs for the built-in Multimodal MCP.',
      ...
      siliconflowKeyReplacePlaceholder: 'Enter a new SiliconFlow key to replace it',
      openaiImageModel: 'OpenAI image model',
      geminiVideoModel: 'Gemini video model',
      siliconflowImageModel: 'SiliconFlow image model',
      siliconflowVideoModel: 'SiliconFlow video model',
      openaiBaseUrl: 'OpenAI request URL',
      geminiBaseUrl: 'Gemini request URL',
      siliconflowBaseUrl: 'SiliconFlow request URL',
      multimodalBaseUrlInvalid: 'Request URLs must be valid http(s) URLs',

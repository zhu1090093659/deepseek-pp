...
export const zhCN = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      multimodalApiDescription: '为内置多模态 MCP 配置 OpenAI、Gemini、SiliconFlow 分析和自定义请求地址。',
      openaiKeyReplacePlaceholder: '输入新 OpenAI Key 可替换',
      geminiKeyReplacePlaceholder: '输入新 Gemini Key 可替换',
      siliconflowKeyReplacePlaceholder: '输入新 SiliconFlow Key 可替换',
      openaiImageModel: 'OpenAI 图片模型',
      geminiVideoModel: 'Gemini 视频模型',
      siliconflowImageModel: 'SiliconFlow 图片模型',
      siliconflowVideoModel: 'SiliconFlow 视频模型',
      openaiBaseUrl: 'OpenAI 请求地址',
      geminiBaseUrl: 'Gemini 请求地址',
      siliconflowBaseUrl: 'SiliconFlow 请求地址',
      multimodalBaseUrlInvalid: '请求地址必须是有效的 http(s) URL',
